...
export function LoginPage() {
  ...
  return (
    <div className="glass glow-accent rounded-2xl p-8">
      <h2 className="mb-1 text-xl font-semibold text-white">Giriş Yap</h2>
      <p className="mb-6 text-sm text-zinc-500">Hesabınıza erişmek için bilgilerinizi girin</p>
      ...
      <div className="mt-6 rounded-xl border border-white/6 bg-white/2 p-3">
        <p className="text-center text-[11px] text-zinc-500">
          Demo hesap: <span className="font-mono text-zinc-400">demo@nexus.com</span> /{' '}
